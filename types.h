...
typedef struct { int x; }* jobject;
typedef struct { int x; }* jarray;
typedef struct { int x; }* jobjectArray;
typedef struct { int x; }* jbyteArray;
typedef struct { int x; }* jbooleanArray;
typedef struct { int x; }* jcharArray;
typedef struct { int x; }* jintArray;
typedef struct { int x; }* jlongArray;
typedef struct { int x; }* jclass;
typedef struct { int x; }* jstring;
typedef jint jsize;
...
/**
 * Enumeration of thread states. Shall be in sync with java.lang.Thread:
 */
typedef enum {
    StateNew = 0,
    StateRunnable = 1,
